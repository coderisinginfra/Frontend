        ...
        data.map((item,index)=>(
          <div key={index} className='data-front-home'>
            ...
            <div className='investment-topics'>
                <h1 className='whoweare'>Why Goa is Top Investment For Real Estate</h1>
