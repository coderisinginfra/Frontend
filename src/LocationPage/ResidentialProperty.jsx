...
const ResidentialProperty = (props) => {
  ...
  return (
    ...
    <Helmet>
      ...
      <meta name="keywords" content="residential properties, homes for sale, apartments for sale, houses for rent, residential real estate, RisingInfra residential, property listings, family homes, luxury apartments, affordable housing, villas for sale, rental apartments, property for rent, residential property management, home buying, residential real estate market, new homes, residential property investment, single-family homes, multi-family properties, residential flats, real estate listings, home for sale, property investment, residential communities, real estate services, rental homes, residential land, residential developments, housing market, ACE Sector 12, Crc Maesta, Stellar one Phase 3, Palm olympia phase 3" />
    </Helmet>
