    ...
    <Box sx={{ display: 'flex'}}>
      ...
      >
        <Toolbar>
          ...
          >
            <MenuIcon />
            <img src={logo} alt="logo" style={{ width: "8em", height: "5em", objectFit: "cover",margin:"0 0 0 3em" }}/>
          </IconButton>
          <Typography
            variant="h6"
            component="div"
          ...
          >
           <img src={logo} alt="logo" style={{ width: "8em", height: "5em", objectFit: "cover", margin:"1em 0 0 5em" }}/>
          </Typography>
