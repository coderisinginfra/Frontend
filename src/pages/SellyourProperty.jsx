...
const SellyourProperty = (props) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            const response = await axios.post('http://localhost:8080/api/v1/sellyourproperty', formData);
    ...
    return (
        <>
            <div className='welcome'>
                <h3>Sell Your Property With<b style={{ color: "red" }}>&nbsp;Risinginfra</b></h3>
            </div>
                    ...
                    <table>
                        <tbody>
                            <tr className="td-data">
                                <td colSpan="2">Add Your Project</td>
                            </tr>
