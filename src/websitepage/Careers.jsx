...
const Careers = (props) => {
        ...
        const fetch = async () => {
            try {
                const [response, categories] = await Promise.all([
                    axios.get("https://backendrisinginfra.risinginfra.in/api/v1/fetchcareers"),
                    axios.get("https://backendrisinginfra.risinginfra.in/api/v1/fetchjobcategory")
                ]);
    ...
    const handleSubmit2 = async (e) => {
        ...
        try {
            ...
            await axios.post("https://backendrisinginfra.risinginfra.in/api/v1/applynow", formDataToSend2, {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post("https://backendrisinginfra.risinginfra.in/api/v1/applynow", formDataToSend, {
                headers: {
                    'Content-Type': 'multipart/form-data',
                },
            });
